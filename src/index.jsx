...
export default function Index() {
  ...
  return (
    <div className="font-sans bg-white dark:bg-gray-900 text-gray-900 dark:text-white min-h-screen">
      ...
      <nav
        id="navigation"
        className="flex justify-between items-center py-6 px-8 bg-white dark:bg-gray-800 shadow"
      >
      ...
      <section className="text-center py-20 bg-gray-50 dark:bg-gray-800">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-8">
          Master Your Placement Preparation with AI. Accelerate your career with
          personalized learning paths, AI-powered quizzes, comprehensive
          progress tracking, and expert-curated content.
        </p>
        <div className="space-x-4">
          ...
          <button className="border border-indigo-600 text-indigo-600 dark:text-indigo-400 px-6 py-3 rounded-lg hover:bg-indigo-50 dark:hover:bg-gray-700">
            Watch Demo
          </button>
        </div>
      </section>
      ...
      <section className="py-20 bg-white dark:bg-gray-900" id="features">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto px-6">
          ...
          <Link
            to="/quizzes"
            className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow hover:shadow-lg block bg-white dark:bg-gray-800"
          >
          ...
          {/* Progress Analytics */}
          <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow hover:shadow-lg bg-white dark:bg-gray-800">
            ...
            <div className="coming-soon">
              ...
              <p className="dark:text-gray-400">Coming Soon!</p>
            </div>
            <p className="text-gray-600 dark:text-gray-300">
              Comprehensive insights into your learning journey with detailed
          ...
          <Link
            ...
            className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow hover:shadow-lg block bg-white dark:bg-gray-800"
          >
            <BookOpen className="w-10 h-10 text-indigo-600 dark:text-indigo-400 mb-4" />
          ...
          <Link
            to="/time-management"
            className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow hover:shadow-lg block transition transform hover:scale-[1.02] bg-white dark:bg-gray-800"
          >
          ...
          <Link
            ...
            className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow hover:shadow-lg block transition transform hover:scale-[1.02] bg-white dark:bg-gray-800"
          >
            <Trophy className="w-10 h-10 text-indigo-600 dark:text-indigo-400 mb-4" />
